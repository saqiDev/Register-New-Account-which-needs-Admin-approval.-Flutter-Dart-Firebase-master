...
class _RegistrationState extends State<Registration> {
  ...
  _saveToDB(){
                    ...
                    _services.uploadImage(_profileImage, 'vendors/${_services.user!.uid}/_coverImage.jpg').then((String? url){
                      if(url!=null ){
                        setState(() {
                          _profileImgUrl=url;
                        });
                                                ...
                                                _services.uploadImage(_coverImage, 'vendors/${_services.user!.uid}/_profileImage.jpg').then((String? url){
                      if(url!=null ){
                        setState(() {
                          _coverImgUrl=url;
                        }
